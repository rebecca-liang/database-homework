<%@ Page Language="C#" MasterPageFile="~/SysAdmin/sysAdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Web.SysAdmin.AddUser" Title="添加用户" %>
        ...
        <table>
            ...
            <tr height="35">
                ...
                <td>
                    ...
                    <font face="宋体">*
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="该项不能为空">
